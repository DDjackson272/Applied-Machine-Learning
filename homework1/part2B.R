...
model_rf_untouched <- randomForest(Number~., data=image_train_data_untouched, maxnodes=2**16-1, ntree=10)
model_rf_stretched <- randomForest(Number~., data=image_train_data_stretched, maxnodes=2**16-1, ntree=10)
